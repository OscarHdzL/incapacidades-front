...
@Component({
  selector: 'app-nota-postquirurgica',
  templateUrl: './nota-postquirurgica.component.html',
  styleUrls: ['./nota-postquirurgica.component.css']
})
export class NotaPostquirurgicaComponent implements OnInit {

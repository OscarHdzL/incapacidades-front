...
@Component({
  selector: 'app-nota-medica-inicial-ginecoobstetricia',
  templateUrl: './nota-medica-inicial-ginecoobstetricia.component.html',
  styleUrls: ['./nota-medica-inicial-ginecoobstetricia.component.css']
})


export class NotaMedicaInicialGinecoobstetriciaComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log("idNotaInicialGinecoSeleccionada: " ,this.idNota);

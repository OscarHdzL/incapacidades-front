...
@Component({
  selector: 'app-nota-medica-inicial',
  templateUrl: './nota-medica-inicial.component.html',
  styleUrls: ['./nota-medica-inicial.component.css']
})

export class NotaMedicaInicialComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("idNotaInicialSeleccionada: " ,this.idNota);
...
this.hospitalizacionService.getNotaInicialFolio("1")
        .subscribe(resp => {
                    
          console.log("DATOS DE LA NOTA", resp);
        }
        );
